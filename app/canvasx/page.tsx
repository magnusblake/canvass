    ...
    <main className="min-h-screen bg-background">
          ...
          {!isPremium && (
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="#benefits">Подробнее</Link>
              </Button>
            </div>
          )}
          {isPremium && (
            <Button size="lg" variant="outline" asChild>
              <Link href="/profile/settings">Управление подпиской</Link>
            </Button>
          )}
        </div>
      ...
      <section id="benefits" className="py-20 container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            CanvasX открывает доступ к эксклюзивным функциям, которые помогут вам выделиться среди других дизайнеров и
            максимально раскрыть свой творческий потенциал.
          </p>
        </div>
      ...
      <section id="comparison" className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto">Выберите план, который подходит именно вам</p>
          </div>
      ...
      <section id="pricing" className="py-20 container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">Выберите подходящий для вас план</p>
        </div>
          ...
          <TabsContent value="monthly" className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8">
              <PricingCard
                ...
                price="0 ₽"
                duration="в месяц"
                features={["До 10 проектов", "Файлы до 10 МБ", "Базовая статистика", "Стандартная поддержка"]}
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto">Что говорят о CanvasX наши пользователи</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-background">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  "CanvasX полностью изменил мой рабочий процесс. Расширенная аналитика помогает мне лучше понимать, как
                  аудитория взаимодействует с моими проектами."
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  "Благодаря премиум-подписке я могу загружать проекты в высоком качестве, что критически важно для моей
                  работы с 3D-визуализациями."
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  "Приоритетное ранжирование в поиске привело к значительному увеличению просмотров моих работ. Это
                  помогло мне найти новых клиентов."
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center bg-card border rounded-lg p-8">
          ...
          <p className="text-muted-foreground mb-8">
            Присоединяйтесь к тысячам дизайнеров, которые уже выбрали CanvasX для развития своего творческого потенциала
            и карьеры.
          </p>
          {!isPremium ? (
            <Button size="lg" asChild>
