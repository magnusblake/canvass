                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Загрузите фотографии для вашего профиля</CardDescription>
                    </CardHeader>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {user.premium ? (
                        <Button size="sm" variant="outline" asChild>
                          <Link href="/canvasx">Посмотреть преимущества</Link>
                        </Button>
                      ) : (
                        <Button size="sm" asChild>
                          <Link href="/canvasx">Перейти на CanvasX</Link>
                        </Button>
                      )}
                    </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <Button variant="outline" asChild>
                              <Link href="/subscription/payment-methods">Изменить способ оплаты</Link>
                            </Button>
                          </div>
                ...
                {!user.premium && (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Разблокируйте все премиум-функции платформы</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
              ...
              <div className="space-y-8">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Настройте, какие уведомления вы хотите получать на email</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Получать нашу ежемесячную рассылку</p>
                        </div>
                        <Switch
            ...
            {activeTab === "security" && (
              <div className="space-y-8">
                ...
                <Card>
                  ...
                  <CardFooter>
                    <Button className="ml-auto">Обновить пароль</Button>
                  </CardFooter>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Повысьте безопасность вашего аккаунта</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Устройства, на которых вы вошли в аккаунт</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Москва, Россия • Активен сейчас</p>
                        </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Удаление аккаунта приведет к полной потере всех данных</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground">
                      Все ваши проекты, комментарии и личные данные будут безвозвратно удалены. Этот процесс не может
                      быть отменен.
                    </p>
                  </CardContent>
                  <CardFooter>
